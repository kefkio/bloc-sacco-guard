 ...
 *      Although Solidity 0.8+ has built-in overflow checks, this library
 *      can be useful for clarity and explicit function calls.
 */
library SafeMath {
    /**
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        // Gas optimization: if a is 0, return 0
        if (a == 0) return 0;
